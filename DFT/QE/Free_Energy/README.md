...
In this exercise, You will learn how to calculate the vibrational modes for the adsorbed species and using the modules within ASE to determine free energies corrections including Entropy term and zero point energy (ZPE). Finally, you will be putting everything together in order to calculate the adsorption free energy.

## Contents
1. [Vibrational Frequencies and Free Energies](#vibrational-frequencies)
