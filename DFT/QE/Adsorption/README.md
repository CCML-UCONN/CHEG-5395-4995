...
<center><img src="eads_eq.png" alt="window" style="width: 300px;"/>
</center>
where CO* refers to adsorbed CO. We have E_surface from the previous exercise, so we will need to calculate E_surface_CO*. The energy of E_CO is -620.461011467 eV.
